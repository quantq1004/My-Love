    ...
    var S, _ = function(e) {
            ...
            return w()(t, e), g()(t, [{
                ...
                value: function() {
                    ...
                    },  Array.from({length: Math.floor(Math.random()*1)+1}).map(function(_, i){
                         var hearts = ['❤️', '💖', '💗', '💝', '💞', '💕', '💓', '❣️'];
                         return o.a.createElement("span",{key:i},hearts[Math.floor(Math.random()*hearts.length)]);
                        }))
                }
            }]), t
        }(o.a.Component),
        ...
        F = function(e) {
            ...
            return w()(t, e), g()(t, [{
                ...
                value: function() {
                    ...
                    var showTitle = t.includes(".title") && t.includes("fadeIn 1.5s");
                    var showMs = t.includes(".message") && t.includes("fadeIn 2s");
